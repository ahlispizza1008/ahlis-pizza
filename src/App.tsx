        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <button
              ...
              className={`font-bold text-xs tracking-wider uppercase transition-colors cursor-pointer relative py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-[#e63946] after:transition-all after:duration-300 ${currentPath === '/' ? 'text-[#e63946] after:w-full' : 'text-stone-600 hover:text-[#e63946]'
                }`}
            >
              Home
            </button>
            ...
            {user && (
              <button
                ...
                className={`font-bold text-xs tracking-wider uppercase transition-colors cursor-pointer relative py-1 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-[#e63946] after:transition-all after:duration-300 ${currentPath === '/my-orders' ? 'text-[#e63946] after:w-full' : 'text-stone-600 hover:text-[#e63946]'
                  }`}
              >
                My Orders
              </button>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            {user ? (
              <div className="hidden md:flex items-center gap-3 mr-1">
                <button
                  onClick={() => navigateTo('/my-orders')}
                  className={`px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-wider rounded-full transition-all duration-300 cursor-pointer border ${currentPath === '/my-orders'
            ...
            >
              <div className="flex flex-col py-4 px-2 gap-3 text-left">
                <button
                  ...
                  className={`font-bold text-xs tracking-wider uppercase py-2.5 px-3 rounded-lg transition-colors w-full text-left cursor-pointer ${currentPath === '/' ? 'text-[#e63946] bg-red-50/50' : 'text-stone-700 hover:text-[#e63946] hover:bg-stone-50'
                    }`}
                >
                  Home
                </button>
                ...
                {user && (
                  <button
                    ...
                    className={`font-bold text-xs tracking-wider uppercase py-2.5 px-3 rounded-lg transition-colors w-full text-left cursor-pointer ${currentPath === '/my-orders' ? 'text-[#e63946] bg-red-50/50' : 'text-stone-700 hover:text-[#e63946] hover:bg-stone-50'
                      }`}
                  >
                    My Orders
                  </button>
                ...
                {user && isAdmin && (
                  <button
                    ...
                    className={`font-bold text-xs tracking-wider uppercase py-2.5 px-3 rounded-lg transition-colors w-full text-left cursor-pointer flex items-center gap-1.5 ${currentPath.startsWith('/admin') ? 'text-[#e63946] bg-red-50/50' : 'text-stone-700 hover:text-[#e63946] hover:bg-stone-50'
                      }`}
                  >
